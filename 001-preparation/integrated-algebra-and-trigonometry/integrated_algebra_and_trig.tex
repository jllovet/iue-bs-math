...
\begin{align}
    &(a+b)+c = a+(b+c) &&\text{Associative Law of Addition}\label{E:AssociativeLawofAddition}\\
    &(ab)c = a(bc) &&\text{Associative Law of Multiplication}\label{E:AssociativeLawofMultiplication}\\
    &a+b = b+a &&\text{Commutative Law of Addition}\label{E:CommutativeLawofAddition}\\
    &ab = ba &&\text{Commutative Law of Multiplication}\label{E:CommutativeLawofMultiplication}\\
