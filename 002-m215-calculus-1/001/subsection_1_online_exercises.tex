...
\newpage
    ...
    \begin{solution}
        ...
        \begin{tikzpicture}
            ...
            \addplot[line width=0.4mm, red, name path=F,domain={-20:2}]{(x+9)^2};
            \end{axis}
        \end{tikzpicture}
        ...
        \begin{tikzpicture}
            ...
            \addplot[line width=0.4mm, red, name path=F,domain={-20:2}]{7*(x+9)^2};
            \end{axis}
        \end{tikzpicture}
        ...
        \begin{tikzpicture}
            ...
            \addplot[line width=0.4mm, red, name path=F,domain={-20:2}]{7*(x+9)^2 + 2};
            \end{axis}
        \end{tikzpicture}
